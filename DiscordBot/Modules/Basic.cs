...
namespace DiscordBot.Modules
{
    public class Basic : ModuleBase<SocketCommandContext>
    {
        ...
        private List<string> _blockedUsernames = ConfigurationManager.AppSettings["BlockedUsernames"]?.Replace(" ", "").Split(new char[] { ',', ';' }, StringSplitOptions.RemoveEmptyEntries).ToList();
